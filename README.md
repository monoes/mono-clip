...
1. Download `MonoClip_0.2.18_aarch64.dmg`
...
chmod +x MonoClip_0.2.18_amd64.AppImage
./MonoClip_0.2.18_amd64.AppImage

# Debian / Ubuntu
sudo apt install ./MonoClip_0.2.18_amd64.deb

# Fedora / RHEL / openSUSE
sudo rpm -i MonoClip-0.2.18-1.x86_64.rpm
```
